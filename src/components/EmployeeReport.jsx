    ...
    <div className="space-y-6 pb-10">
      <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-6 flex flex-col md:flex-row gap-4 items-end">
        <div className="flex-1 w-full">
          <label className="block text-sm font-bold text-crm-primary mb-1">Search Employee</label>
        ...
        <button onClick={handleExportCSV} className="bg-black hover:bg-neutral-800 text-white px-6 py-2 rounded-lg font-black shadow-sm flex items-center gap-2 h-10 transition-colors w-full md:w-auto justify-center">
        ...
        <table className="w-full text-left border-collapse text-crm-textDark min-w-[800px]">
          <thead>
            <tr className="bg-gray-100 border-b border-gray-200">
              ...
              <th className="px-4 py-3 text-crm-primary font-black">Full Name</th>
              <th className="px-4 py-3 text-crm-primary font-black">Email</th>
              ...
              <th className="px-4 py-3 text-crm-primary font-black">Registered On</th>
            </tr>
          </thead>
          <tbody>
